...
parser = argparse.ArgumentParser(description="Pwntools Command-line Interface", prog="pwn")
...
def deprecated_main():
    ...
    warnings.warn(
        "The '%s' command is deprecated and will be removed in a future version. Please use 'pwn %s' instead."
        % (name, name),
        DeprecationWarning,
        stacklevel=2,
    )
