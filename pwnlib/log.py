...
from pwnlib.context import Thread, context
from pwnlib.exception import PwnlibException
from pwnlib.term import spinners, text
...
class Handler(logging.StreamHandler):
    ...
    def emit(self, record):
        ...
        if (
            progress is None
            or not term.term_mode
            or not os.path.sameopenfile(context.log_console.fileno(), term.term.fd.fileno())
        ):
