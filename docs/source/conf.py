...
latex_documents = [
    ("index", "pwntools.tex", "pwntools Documentation", "2016, Gallopsled et al.", "manual"),
]
...
man_pages = [("index", "pwntools", "pwntools Documentation", ["2016, Gallopsled et al."], 1)]
...
texinfo_documents = [
    ("index", "pwntools", "pwntools Documentation", "", "pwntools", "CTF exploit writing toolkit.", "Miscellaneous"),
]
